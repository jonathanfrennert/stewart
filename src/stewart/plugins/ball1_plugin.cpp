#ifndef _BALL1_PLUGIN_HH_
#define _BALL1_PLUGIN_HH_
...
namespace gazebo
{
    ...
    class Ball1Plugin : public ModelPlugin
    {
      /// \brief Constructor
      public: Ball1Plugin() {}
        ...
        virtual void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
        {
          ...
          std::cout << "BALL1 PLUGIN: ROS is initialized" << "\n\n";
          ...
          ros::SubscribeOptions so = ros::SubscribeOptions::create<std_msgs::Float32MultiArray>(
              ...
              100,
              boost::bind(&Ball1Plugin::OnRosMsg, this, _1),
              ros::VoidPtr(), &this->rosQueue);
          this->rosSub = this->rosNode->subscribe(so);

          // Spin up the queue helper thread.
          this->rosQueueThread =
           std::thread(std::bind(&Ball1Plugin::QueueThread, this));
    ...
    GZ_REGISTER_MODEL_PLUGIN(Ball1Plugin)
}

#endif // _BALL1_PLUGIN_HH_
